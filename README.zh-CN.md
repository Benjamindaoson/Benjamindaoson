...
## 🤖 Agent Harness
<sub><b>智能体系统工程</b><br/>Runtime · 状态 · 工具 · 编排 · 恢复 · 评估</sub>

</td>
<td width="33%" valign="top">

## 🧠 大模型与模型系统
<sub><b>训练 · 后训练 · 评估</b><br/>微调 · 奖励模型 · 偏好学习 · 多模态评估</sub>

</td>
<td width="33%" valign="top">

## 🦾 Physical AI
<sub><b>具身智能</b><br/>VLA · 仿真 · 物理证据 · 具身数据</sub>
...
<a href="https://github.com/Benjamindaoson/haole"><img src="./assets/cards-v3/haole-architecture.svg" width="100%" alt="Haole 架构" /></a>
...
<a href="https://github.com/Benjamindaoson/chinese-news-classification"><img src="./assets/cards-v3/chinese-news-model-results.svg" width="100%" alt="中文新闻分类模型压缩结果" /></a>
...
<a href="https://github.com/Benjamindaoson/Embodied-DataOps"><img src="./assets/cards-v3/embodied-dataops-status.svg" width="100%" alt="Embodied-DataOps 当前状态" /></a>
...
<p align="center">
  <sub><b>构建真正有用的 AI 系统 · 做真实实验 · 为开放知识做贡献。</b></sub>
</p>
